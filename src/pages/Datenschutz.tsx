    ...
    <Layout>
      <section className="page-header gradient-navy">
        <div className="section-container">
          <h1 className="font-heading text-4xl md:text-5xl font-bold">Datenschutzerklärung</h1>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="section-container">
          <div className="max-w-3xl mx-auto prose prose-slate">
            ...
            <h2 className="font-heading text-2xl font-bold mb-6">1. Datenschutz auf einen Blick</h2>
            
            <h3 className="font-heading text-xl font-semibold mt-8 mb-4">Allgemeine Hinweise</h3>
            <p>
            ...
            <h3 className="font-heading text-xl font-semibold mt-8 mb-4">Datenerfassung auf dieser Website</h3>
            ...
            <h4 className="font-semibold mt-4 mb-2">Wofür nutzen wir Ihre Daten?</h4>
            <p>
              Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu 
              gewährleisten. Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden.
            </p>

            <h4 className="font-semibold mt-4 mb-2">Welche Rechte haben Sie bezüglich Ihrer Daten?</h4>
            <p>
            ...
            <h2 className="font-heading text-2xl font-bold mt-12 mb-6">2. Hosting</h2>
            <p>
              Wir hosten die Inhalte unserer Website bei einem externen Hosting-Anbieter. 
              Personenbezogene Daten, die auf dieser Website erfasst werden, werden auf den 
              Servern des Hosters gespeichert.
            </p>

            <h2 className="font-heading text-2xl font-bold mt-12 mb-6">3. Allgemeine Hinweise und Pflichtinformationen</h2>
            
            <h3 className="font-heading text-xl font-semibold mt-8 mb-4">Datenschutz</h3>
            <p>
            ...
            <h3 className="font-heading text-xl font-semibold mt-8 mb-4">Hinweis zur verantwortlichen Stelle</h3>
            <div className="bg-card border border-border rounded-lg p-6 my-4">
              <p>
                Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:
              </p>
              <p className="mt-4">
                <strong>ULTRIX UG (haftungsbeschränkt)</strong><br />
                Nikolaus Bauer<br />
                Weihgartenstr. 19<br />
                68519 Viernheim
              </p>
            ...
            <h3 className="font-heading text-xl font-semibold mt-8 mb-4">Speicherdauer</h3>
            <p>
            ...
            <h3 className="font-heading text-xl font-semibold mt-8 mb-4">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
            <p>
            ...
            <h3 className="font-heading text-xl font-semibold mt-8 mb-4">Recht auf Datenübertragbarkeit</h3>
            <p>
            ...
            <h3 className="font-heading text-xl font-semibold mt-8 mb-4">Auskunft, Löschung und Berichtigung</h3>
            <p>
            ...
            <h2 className="font-heading text-2xl font-bold mt-12 mb-6">4. Datenerfassung auf dieser Website</h2>

            <h3 className="font-heading text-xl font-semibold mt-8 mb-4">Kontaktformular</h3>
            <p>
            ...
            <h3 className="font-heading text-xl font-semibold mt-8 mb-4">Fahrzeugverkauf-Formular</h3>
            <p>
              Wenn Sie über unser Fahrzeugverkauf-Formular eine Anfrage stellen, werden Ihre 
              eingegebenen Daten (Kontaktdaten, Fahrzeugdaten, Bilder) zur Bearbeitung Ihrer 
              Verkaufsanfrage gespeichert. Die Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO 
              (vorvertragliche Maßnahmen). Die Daten werden gelöscht, sobald sie für die 
